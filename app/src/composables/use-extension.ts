import type { AppExtensionConfigs, AppExtensionType, HybridExtensionType } from '@d11f/types';
import type { Plural } from '@d11f/types';
import { pluralize } from '@d11f/utils';
